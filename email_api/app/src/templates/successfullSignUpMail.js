    ...
    getTemplate(options, path) {
        ...
        return {
            ...
            html: "<h3>Bonjour " + options.templateOptions.lName + " " + options.templateOptions.fName + "</h3>"
                ...
                + "<a href='https://msia17conferences.com"+ path +"?userdata=" + options.userdata + "&delete=true' target='_blank'>Se Désinscrire</a> | "
                + "<a href='https://msia17conferences.com"+ path +"?userdata=" + options.userdata + "&update=true' target='_blank'>Modifier mes informations</a>",
